...
export class ProtectedApi extends Construct {
  constructor(scope: Construct, id: string, props: ProtectedApiProps) {
    ...
    const notificationsProps = {
      ...
      environment: {
        GRAPHQL_ENDPOINT:
          "https://hx6p3rjzlvdvlekil24yiikwtm.appsync-api.eu-west-1.amazonaws.com/graphql",
        GRAPHQL_API_KEY: "",
      },
    };
    ...
    locationEndpoint.addMethod(
      "POST",
      new LambdaIntegration(setLocationRecord),
      {
        authorizer: requestAuthorizer,
        authorizationType: AuthorizationType.CUSTOM,
      }
    ...
    invitationsEndpoint.addMethod(
      "POST",
      new LambdaIntegration(createInvitation),
      {
        authorizer: requestAuthorizer,
        authorizationType: AuthorizationType.CUSTOM,
      }
    ...
    invitationsEndpoint.addMethod(
      "GET",
      new LambdaIntegration(getInvitations),
      {
        authorizer: requestAuthorizer,
        authorizationType: AuthorizationType.CUSTOM,
      }
    ...
    // PUT '/invitations/:id'
    invitationDeleteById.addMethod(
      "DELETE",
      new LambdaIntegration(deleteInvitation),
      {
        authorizer: requestAuthorizer,
        authorizationType: AuthorizationType.CUSTOM,
      }
    ...
    notificationsEndpoint.addMethod(
      "POST",
      new LambdaIntegration(createNotification),
      {
        authorizer: requestAuthorizer,
        authorizationType: AuthorizationType.CUSTOM,
      }
